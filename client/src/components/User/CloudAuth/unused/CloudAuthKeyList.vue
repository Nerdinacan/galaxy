        ...
        <header>
                    ...
                    <ul>
                        <li class="cloudKeyHelp">
                            <a
                                ...
                                title="Instructions"
                            >
                                <span v-localize>Instructions</span>
                            </a>
                        </li>
                        ...
                        <li class="createCloudKey">
                            ...
                            >
                                <span v-localize>Create New Key</span>
                            </a>
                        </li>
                    </ul>
                </nav>
            ...
            <transition name="fade">
                <hgroup v-if="showHelp">
                    <p>See the online <a href="https://galaxyproject.org/authnz/cloud/">Documentation</a>.</p>
                </hgroup>
            </transition>
...
import { listCredentials, saveCredential, deleteCredential } from "./model/service";
...
export default {
    ...
    methods: {
        ...
        deleteKey() {
            ...
            deleteCredential(this.doomedItem)
