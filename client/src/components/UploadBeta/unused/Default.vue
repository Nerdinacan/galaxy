<template>
    <upload-wrapper ref="wrapper" class="upload-view-default" :highlight-box="highlightBox">
        <!-- drop files region -->
        <div class="upload-helper" v-if="showDropZone"><i class="fa fa-files-o" />Drop files here</div>

        <!-- listing -->
        <table class="upload-table ui-table-striped" v-else ref="uploadTable">
            <thead>
                <tr>
                    <th>Name</th>
                    <th>Size</th>
...
export default {
    ...
    components: { UploadWrapper, BButton },
    data() {
        return {
            // drop-zone region
            showDropZone: true,
